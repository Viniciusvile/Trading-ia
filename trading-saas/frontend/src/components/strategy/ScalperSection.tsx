      ...
      <div className="relative w-full max-w-2xl bg-[var(--color-surface-2)] border border-[var(--color-border)] rounded-[var(--radius-md)] shadow-2xl p-6 max-h-[calc(100vh-2rem)] sm:max-h-[calc(100vh-4rem)] flex flex-col overflow-hidden">
        ...
        {!result && !analyzing && (
          <>
            ...
            <div className="flex flex-col sm:flex-row justify-between gap-3 border-t border-[var(--color-border)] pt-4 mt-auto">
              <Button variant="ghost" onClick={onClose} className="w-full sm:w-auto order-last sm:order-first">
                Cancelar
              </Button>
              <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                ...
                >
                  <FlaskConical size={14} className="mr-1.5" /> Analisar no Mercado (5m)
                </Button>
                <Button 
                  variant="success" 
                  disabled={saving} 
        ...
        {result && !analyzing && (
          <>
            ...
            <div className="flex flex-col sm:flex-row justify-between gap-3 border-t border-[var(--color-border)] pt-4 mt-auto">
              <Button variant="ghost" onClick={() => setResult(null)} className="w-full sm:w-auto order-last sm:order-first whitespace-nowrap">
